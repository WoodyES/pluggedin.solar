---
title: "Plug-in Solar With Octopus Agile: Maximising Time-of-Use Savings"
...
You need visibility of both generation and consumption to time things properly. A [Shelly Plus Plug UK](https://amzn.to/4sfA9nK) on your inverter output shows real-time solar generation. An [Emporia Vue 3](https://amzn.to/4bUCQ9E) on your main supply shows whole-home consumption.
...
If you use Home Assistant (see our [HA monitoring guide](/blog/solar-panel-monitoring-home-assistant-uk)), you can automate this entirely — battery charges from solar when available, from grid when prices drop below a threshold, and discharges during peak pricing.
