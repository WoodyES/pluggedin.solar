...
Our [savings calculator](/calculator) takes six key inputs about your system and home:
...
| Region | 800W South-Facing (Tilted) | Annual Savings (Est.) |
|--------|------|---------|
| London | ~850 kWh | £240–£280 |
| Bristol | ~800 kWh | £225–£265 |
| Manchester | ~750 kWh | £210–£250 |
| Glasgow | ~700 kWh | £195–£230 |
| Edinburgh | ~680 kWh | £190–£220 |
...
If you're unsure which direction your roof or balcony faces, run our free [Solar Report](/report) tool. It uses satellite imagery and a sun-exposure algorithm to grade your property's solar potential and tell you exactly where the best panels would go.
...
Read [Battery Storage vs No Battery](/blog/battery-storage-vs-no-battery-plug-in-solar-uk) for a deeper dive.
...
- **No shading** – we assume your panels are in full sun. If a chimney, tree, or building casts a shadow for part of the day, real output will be lower. Use [Solar Report](/report) to check for shade.
...
For a reality check, read [How Accurate Are Solar Savings Calculators?](/blog/plug-in-solar-savings-calculator-accuracy-uk) to understand the ±5–10% uncertainty band around any calculator estimate.

## Beyond the Calculator: Use the Solar Report Too

For a richer picture of your property's solar potential, run our free [Solar Report](/report). It uses satellite building footprints and a sun-exposure algorithm to:
...
4. **Read buying guides** – explore [the best plug-in solar kits](/blog/best-plug-in-solar-kit-uk) and [How to Install Plug-in Solar](/blog/how-to-install-plug-in-solar-uk).
5. **Take the Panel Finder Quiz** – unsure on system size? Our [quiz](/quiz) will recommend a kit based on your answers.
