...
Your inverter already does per-panel tracking. Save the £200–400 and reinvest it in other equipment — like a [multimeter](https://amzn.to/4bSN4aq) for maintenance or a battery for storage.
...
*Want to learn more about how inverters actually work? Read our guide on [string vs parallel wiring for plug-in solar](/blog/plug-in-solar-string-vs-parallel-wiring-uk).*
