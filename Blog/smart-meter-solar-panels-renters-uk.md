...
Once your smart meter is in and you've installed [plug-in solar](/blog/balcony-solar-uk), you can apply for the [Smart Export Guarantee](/blog/smart-meter-export-register-solar-uk) exactly as an owner-occupier would. The SEG agreement is between you and the energy supplier, not linked to property ownership.
...
A practical approach: use a [smart plug monitor](/blog/best-smart-plug-monitor-solar-uk) on the solar circuit to measure actual generation. Split the value of that generation (import rate × kWh) proportionally.
