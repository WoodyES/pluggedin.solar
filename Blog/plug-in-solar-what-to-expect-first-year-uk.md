---
slug: "plug-in-solar-what-to-expect-first-year-uk"
...
No. This is completely normal. A 800W system simply cannot overcome short days and low sun angles. If your monitoring app shows *any* generation during daylight hours, the system is working. For context, see our [January generation guide](/blog/plug-in-solar-january-uk-generation).
...
Read our detailed [spring performance guide](/blog/when-does-plug-in-solar-get-good-uk-spring) for more.
...
1. **Load-shifting** — run appliances during peak generation. This is the cheapest and most effective solution.
2. **Smart export tariffs** — some suppliers (notably Octopus Energy) offer export payments of 4-15p per kWh. Worth investigating if your export is significant.
3. **Battery storage** — stores daytime generation for evening use. Currently excluded from the [interim product specification](/blog/plug-in-solar-interim-product-specification-uk) for plug-and-play systems, but can be added separately by an electrician.

For a detailed look at export options, see our [export guide](/blog/plug-in-solar-generating-too-much-export-uk).
...
If your panels are flat (0°), however, tilting them to even 15-20° makes a meaningful difference. See our [panel angle guide](/blog/plug-in-solar-panel-angle-uk) for the full analysis.
...
For a personalised estimate, use our [savings calculator](/calculator).
...
- **Dirt and debris** — clean panels once or twice a year. Rain does most of the work, but bird droppings and tree pollen can accumulate. See our [maintenance guide](/blog/maintain-plug-in-solar-panels-uk).
