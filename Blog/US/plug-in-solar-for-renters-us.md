...
Check [our state-by-state guide](/us/blog/is-plug-in-solar-legal-in-my-state) for your specific jurisdiction.
...
1. **Unplug the system at least a day before moving.** Let it power down fully.
2. **Safely store the panel.** Don't crack the glass or bend the frame.
3. **Keep all cables, connectors, and the microinverter together.** Take photos if needed to remember how it was wired.
4. **At your new place, check the outlet you plan to use.** Is it on a circuit that's safe for 1,200 watts? (Usually yes, but ask your landlord or use an outlet on a different circuit if one seems heavily loaded.)
5. **Reassemble and plug in.** Most systems are identical to reinstall—just reverse the removal process.
