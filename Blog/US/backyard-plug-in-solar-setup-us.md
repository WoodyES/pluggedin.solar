...
**Process:**
1. Position the frame where you want it, ensuring level ground
2. Check that it's square and level (use a level tool)
3. If needed, add shims under legs to level it
4. For ground-mounted systems, ballast or stake the frame to prevent tipping
...
**Process:**
1. Route cable through a hole or gap in your wall/door
2. Seal the gap with weatherproof caulk or expanding foam
3. Use a cable bushing or grommet to protect the cable where it enters
...
**Steep angle (40–50°):** Snow slides off easily.
**Shallow angle (20–30°):** Snow accumulates and might need clearing.
...
Ready to set up your backyard system? See [the complete installation guide](/us/blog/how-to-install-plug-in-solar-us) or [where to place panels for optimal sun](/us/blog/where-to-put-plug-in-solar-panels-us).
