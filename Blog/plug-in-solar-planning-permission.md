...
If you're renting, you may need your landlord's permission (a separate matter from planning permission) — see our [renters guide](/blog/plug-in-solar-for-renters-uk).
...
[Adjustable tilt brackets](https://amzn.to/4maeAng) let you angle panels for maximum output without exceeding the 200mm protrusion limit.
...
Ballast-mounted frames are ideal here: no drilling, no structural work, easy to remove. See our [flat roof installation guide](/blog/flat-roof-plug-in-solar-uk).
...
**Leasehold flats and management companies.** Planning permission and building management rules are separate systems. Your council may say no planning permission is needed, but your freeholder or management company may have their own restrictions on external installations. You may need their written approval. See our [balcony solar for renters guide](/blog/plug-in-solar-for-renters-uk) for how to approach this.

## The Quick Check (5 Minutes)

If you're uncertain about your specific property:

1. Search your postcode on the [Planning Portal](https://www.planningportal.co.uk/) to check if your property is listed or in a conservation area
2. If it's neither — you don't need planning permission, full stop
3. If it is listed or in a conservation area — email your council's planning department: "I'm planning to install a portable plug-in solar panel on my [balcony/garden/shed]. Does this require planning permission or listed building consent?" They'll reply within a few working days
4. If you're in a leasehold flat — check your lease for clauses about external alterations, and email your management company

## Frequently Asked Questions

**Do I need planning permission for solar panels on my balcony?**
No. A plug-in panel on a balcony railing or floor is a portable device, not a structural change. It falls under permitted development rights.

**Do I need planning permission for solar panels on my shed?**
No, provided the panels don't project above the highest point of the shed roof. Standard plug-in solar panels mounted flat or on a low-angle frame are well within limits.
