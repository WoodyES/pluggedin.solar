...
- Use the [Solar Report](/report) tool (it tells you your building's aspect automatically)
...
- Use the [Solar Report](/report) tool, which shows shade patterns month-by-month
...
If you pass the five-question checklist, run the [Solar Report](/report) tool. It's free, map-based, and takes 2 minutes:
...
**Problem:** North-facing surfaces generate 10–15% of south-facing systems.
**Solution:** 
...
**Problem:** Shadows cut output 20–50%.
**Solution:**
...
**Problem:** Balcony panels are vertical, losing 22% output vs. tilted.
**Solution:**
...
**Problem:** Can't modify the property without permission.
**Solution:**
...
**Problem:** Nearest 13A socket is 15m away; cable runs are long.
**Solution:**
...
**Problem:** Your house has old wiring; the circuit may not handle 13A continuous load.
**Solution:**
...
**In these cases:**
- [Switch to a Time-of-Use tariff first](/blog/best-energy-tariff-plug-in-solar-uk-2026) (free, improves returns 20–30%)
...
See [Is Plug-in Solar a Good Investment?](/blog/is-plug-in-solar-good-investment-uk-2026) for detailed financial decision-making.
...
2. **Run the Solar Report** – get your sun-exposure grade ([/report](/report))
3. **If you're "Good" or better, run the calculator** – see actual savings for your postcode ([/calculator](/calculator))
...
**Ready to check your property?** [Run the Solar Report](/report) now—60 seconds, no sign-up.
