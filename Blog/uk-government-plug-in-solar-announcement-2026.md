...
1. **Check BSI compliance** — ensure the kit explicitly meets the 2026 BSI product standard
2. **File G98 within 28 days** — keep the DNO notification receipt as proof of compliance
3. **Monitor with smart plugs** — use [TP-Link Tapo P110 smart plugs](https://amzn.to/4m9Yh9U) (~£15) to track real-time output and validate performance
4. **Store documentation** — keep invoices, G98 receipt, and electrical inspection records for future house sales
5. **Consider battery backup** — pair your kit with a battery like the [EcoFlow STREAM](https://www.awin1.com/cread.php?awinmid=51797&awinaffid=2846734&ued=https%3A%2F%2Fwww.ecoflow.com%2Fuk%2Fstream-balcony-solar-system) (~£699) to maximise the benefit of generation in off-peak hours
