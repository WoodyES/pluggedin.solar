---
slug: "plug-in-solar-electricity-bill-before-after-uk"
...
Annual generation in Bristol: approximately 780 kWh
Self-consumption rate: 65% (she's home during generation hours, but the flat's total daytime load doesn't always match generation)
Self-consumed: 507 kWh
Exported: 273 kWh
...
Annual generation in Nottingham: approximately 820 kWh
Self-consumption rate: 55% (partially occupied during the day — some days both parents are out)
Self-consumed: 451 kWh
Exported: 369 kWh
...
Annual generation in Suffolk: approximately 870 kWh (East Anglia gets good sun)
Self-consumption rate: 78% (home all day, steady baseload)
Self-consumed: 679 kWh
Exported: 191 kWh
...
One thing plug-in solar cannot reduce is your standing charge — roughly 30p/day or £110/year, payable regardless of consumption. Your bill will never reach zero from solar alone. For more on this, see our [guide to standing charges and plug-in solar](/blog/plug-in-solar-standing-charge-impact-uk).


---
<div class="product-card featured">
<div class="pc-accent"></div>
<div class="pc-badge">See your own savings</div>
...
1. **Find your current usage:** check your last 12 months of electricity bills or your smart meter data. Note the total kWh consumed and the average monthly bill
2. **Estimate your generation:** use our [savings calculator](/calculator) with your postcode for a location-specific figure
3. **Estimate self-consumption:** if you're home all day, use 70-80%. If you're out 9-5, use 35-45%. If you're home part-time, use 50-60%
4. **Calculate the saving:** self-consumed kWh x your tariff rate = your annual saving from self-consumption. Add exported kWh x your export rate for the total
