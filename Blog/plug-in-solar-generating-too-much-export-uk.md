---
title: "My Plug-in Solar Is Generating More Than I'm Using — Is That a Problem?"
...
From your perspective: you generated electricity, but you didn't use it, and (unless you've set up a [Smart Export Guarantee](/blog/plug-in-solar-smart-meter-exports-uk) tariff) you're not getting paid for it. It's essentially given away for free.
...
The exception is Octopus Energy, who have an informal arrangement allowing small plug-in solar owners to access export payments in some circumstances — but this isn't a firm entitlement and requires a [smart meter](/blog/smart-meter-solar-panels-complete-guide-uk) that can measure exports separately.

For the majority of plug-in solar owners, exports will go unpaid for the foreseeable future. This means the value of your system is entirely in **[self-consumption](/blog/smart-meter-solar-self-consumption-uk)** — electricity you generate and use yourself, displacing grid electricity you'd otherwise pay for.

Our [SEG explainer](/blog/plug-in-solar-export-payments-seg-uk) covers the MCS certification issue in detail.
...
**Set your immersion heater to solar hours** — if you have an electric immersion heater (common in properties without gas), a timer set to midday can shift a significant chunk of hot water heating load to free solar generation. An [Emporia Vue 3](https://amzn.to/4bUCQ9E) lets you monitor whether this is actually working as intended.

## The Battery Solution

The cleanest fix for the over-generation problem is [battery storage](/blog/battery-storage-vs-no-battery-plug-in-solar-uk). A battery absorbs surplus generation during the day and makes it available in the evening — which is when most UK households consume most of their electricity.

A [battery like the EcoFlow DELTA 2](https://www.awin1.com/cread.php?awinmid=51797&awinaffid=2846734&ued=https%3A%2F%2Fwww.ecoflow.com%2Fuk%2Fdelta-2-portable-power-station) with roughly 1kWh of usable storage can capture a significant portion of a summer day's surplus. The maths: if your 800W system generates 4 kWh on a June day and you use 1.2 kWh at home during those hours, you're exporting 2.8 kWh. A battery absorbs up to ~1 kWh of that — which you then use in the evening at full grid-avoidance value (currently around 22-25p/kWh). That's an extra 22-25p of value per day vs zero without storage.
...
This requires both a battery and a smart meter. If you already have the battery, the tariff upgrade can add meaningful value on top of the self-consumption benefit. See our [Octopus Flux review](/blog/octopus-flux-tariff-review-uk) for whether the numbers work.
