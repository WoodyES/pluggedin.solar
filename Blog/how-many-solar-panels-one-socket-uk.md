...
- **[TP-Link Tapo P110 smart plugs](https://amzn.to/4m9Yh9U)** (~£15 each)—plug your inverters into these to track real-time generation, daily totals, and costs per system
- **[Emporia Vue 3](https://amzn.to/4bUCQ9E)** (~£90)—for whole-home circuit-level monitoring, letting you see how each system contributes to your household demand

A multimeter like the **[Fluke 117](https://amzn.to/4bSN4aq)** (~£199) is useful for verifying DC input voltages during commissioning, especially if you're comparing performance between systems.
