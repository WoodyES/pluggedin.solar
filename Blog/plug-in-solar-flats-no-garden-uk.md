...
**Step-by-step:**
1. **Check your lease.** Search for clauses on "alterations," "external installations," or "building fabric." Some newer leases explicitly permit solar.
2. **Write to the management company.** Include photos showing exactly where you'd install, detailed product specifications, and a statement that the installation is reversible with no permanent damage.
3. **Allow 4–6 weeks for a response.** By law, freeholders must respond within a reasonable timeframe.
4. **Expect conditions.** They might require insurance, a professional installer, or removal when you sell—all reasonable.
5. **Get it in writing.** Once approved, keep the letter as evidence.
