...
This article explains what a Solar Report contains, how to read it, and how to use the results alongside the [savings calculator](/calculator).
...
The [Solar Report tool](/report) is map-based. Here's how:
...
- **Next step:** [Run the calculator](/calculator) with "South-facing, roof-top, London" to see estimated savings
...
- **Next step:** [Run the calculator](/calculator) with the reduced output factor in mind (~15% penalty). Still viable, payback ~3.9 years instead of 3.1.
...
- **Next step:** [Run the calculator](/calculator) with "balcony, south-west, Manchester" to compare vertical vs. tilted options.
...
3. **If your grade is "Limited" or "Not Ideal"**, either:
   ...
   - Accept the reduced output and [run the calculator](/calculator) with a penalty factor (e.g. -30% for significant shade)
...
### Option 1: Accept It
"My property gets 80% of ideal output." Run the [calculator](/calculator) with -20% output. Payback extends from 3.1 to 3.9 years. Still viable? Go ahead.
...
**Ready to check your property?** [Run the Solar Report](/report).
