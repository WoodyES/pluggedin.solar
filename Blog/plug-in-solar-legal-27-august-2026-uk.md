---
title: "Plug-In Solar Is Legal from 27 August 2026"
slug: plug-in-solar-legal-27-august-2026-uk
excerpt: "SI 2026 No. 848 comes into force on 27 August, making plug-in solar legal in the UK. Here's what it means and what you can buy."
date: 2026-08-14
...
This is the culmination of a process that started with the [government announcement in March 2026](/blog/uk-government-plug-in-solar-announcement-2026) and moved through [BS 7671 Amendment 4](/blog/bs7671-amendment-4-explained), the [DESNZ consultation](/blog/desnz-plug-in-solar-consultation-july-2026), and the publication of the [Interim Product Specification v2](/blog/interim-product-specification-v2-plug-in-solar-uk).

## What Does SI 2026 No. 848 Actually Say?

The statutory instrument amends existing safety regulations to create a legal exemption for plug-in microgenerators that meet the [Interim Product Specification](/blog/plug-in-solar-interim-product-specification-uk). In plain English:
...
As of 14 August 2026, **no kits are yet certified to the Interim Product Specification**. The first compliant kit — the [EcoFlow STREAM](/blog/ecoflow-stream-review-uk) — is expected to launch in **September 2026**, with [early-bird pre-orders](/blog/ecoflow-stream-early-bird-pre-order-uk) open from 12 August to 15 September.
...
If you've already set up a DIY system with a [Hoymiles microinverter](/blog/hoymiles-hms800-review-uk) or [APsystems EZ1-M](/blog/apsystems-ez1-m-review-uk), your setup doesn't automatically become legal on 27 August. The law requires kits to meet the Interim Product Specification — which means they need to be sold as a certified complete system, not assembled from parts.
...
With higher self-consumption — achievable with [smart home automation](/blog/plug-in-solar-smart-home-automation-uk) and [load shifting](/blog/plug-in-solar-self-consumption-tips-uk) — savings can reach **£200+ per year**.

Use our [calculator](/calculator) to get an estimate for your postcode.

## What About the £25m Government Pilot?

The government announced a [£25m pilot programme](/blog/25m-government-pilot-plug-in-solar-uk) on 21 April 2026, aimed at providing plug-in solar kits to low-income households. Details on eligibility and application are expected alongside the first kit launches in September.

## What Happens Next?

- **27 August 2026**: SI 2026/848 comes into force — plug-in solar is legal
- **September 2026**: [EcoFlow STREAM launches](/blog/ecoflow-stream-uk-launch-september-2026) as the first certified kit
...
If you're ready to commit, the [EcoFlow STREAM early-bird pre-order](/blog/ecoflow-stream-early-bird-pre-order-uk) offers the best launch pricing. If you'd rather wait for more choice, retailers like B&Q and Currys will likely stock alternatives from late 2026.

Either way, use the [savings calculator](/calculator) now so you know exactly what to expect.
...
No. Compliant kits are designed to be plugged into a standard 13A wall socket by the householder. You do need to [notify your DNO](/blog/g98-dno-notification-step-by-step) within 28 days.
