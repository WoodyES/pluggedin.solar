---
title: "What Happens to My Plug-in Solar When I Move House?"
...
**1. Check the new property's circuit** — before reinstalling, verify the socket you're planning to use is on a ring main with a Type A RCD (see our [RCD guide](/blog/plug-in-solar-rcd-tripping-uk)). In an unfamiliar property, it's worth getting an electrician to check if you're unsure.
...
**3. Submit a new G98 notification** — this is required at the new address. The G98 process is straightforward (fill in the form, submit to your new DNO, receive acknowledgement within a few days). See our [G98 guide](/blog/g98-notification-guide-uk-homeowners) for the step-by-step.
