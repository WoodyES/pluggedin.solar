---
title: "Best Micro Inverters for Plug-in Solar in the UK (2026)"
...
Once installed, you can verify your inverter is working correctly with a [multimeter like the Fluke 117](https://amzn.to/4bSN4aq). Check the AC output voltage at the socket — it should read 230-253V. Check the frequency — it should be 50Hz ±0.5Hz. Any deviation suggests a fault.

For ongoing monitoring, a [smart plug](https://amzn.to/4m9Yh9U) gives you continuous power output data independently of the inverter's own app — useful for cross-checking accuracy.
...
For the complete kit comparison, see our [buyer's guide](/blog/best-plug-in-solar-kit-uk).
