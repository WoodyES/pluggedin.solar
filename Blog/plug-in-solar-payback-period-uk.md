...
That's **4–6 months shorter** than a standard tariff, just by switching supplier. See [the tariff guide](/blog/best-energy-tariff-plug-in-solar-uk-2026) for details.
...
Once BSI-compliant kits launch (July 2026), expect prices in the £500–£1,200 range. Check the [buying guide](/blog/best-plug-in-solar-kit-uk) for current pricing.
...
Still viable, but noticeably longer. This is where aspect really matters. See [South-Facing vs East/West](/blog/south-facing-vs-east-west-solar-uk) for details.
...
Check [the Solar Report](/report) for shade patterns before installing.
...
Vertical panels lose ~22% output vs. tilted, due to the steeper angle of incidence. Still good, but payback is longer. See [Balcony Solar Output](/blog/balcony-solar-output-calculator-uk) for the reality of vertical panels.
...
Battery storage is expensive, so it only makes sense if you have high evening usage and a ToU tariff that rewards it. See [Battery vs No Battery](/blog/battery-storage-vs-no-battery-plug-in-solar-uk) for the detailed comparison.
...
1. **East or west-facing with shading** – 40% reduction in output pushes payback past 5 years
2. **Flat-roof, unshaded, but vertical panels** – only ~22% output loss, but still tightens payback
3. **Very northern location (Scotland) + high system cost** – close to 4-year payback, any extra cost pushes it beyond
4. **You work away all day + standard tariff** – low self-consumption means most solar is exported at 0p, tanking payback
5. **System costs above £1.20/W** – rare in the current market, but possible with premium brands

The fix: Either improve your situation (change tariff, add a battery for evening storage, trim that tree casting shade) or reconsider the size/placement. See [Is Plug-in Solar a Good Investment?](/blog/is-plug-in-solar-good-investment-uk-2026) for when to skip solar entirely.

## How to Improve Payback for Your Situation

1. **Switch to a ToU tariff** – gain 4–6 months of payback improvement (Octopus Flux, Go, etc.)
2. **Install on your best aspect** – south-facing beats east/west by ~0.8 years
3. **Ensure no shading** – check [the Solar Report](/report] for shade patterns
4. **Work from home?** – high daytime usage tightens payback by 0.4–0.6 years
5. **Add battery storage** – only if you have evening load + ToU tariff (costs ~£200, gains ~0.3 years)
...
**Ready to see your exact payback?** [Run the calculator](/calculator) with your postcode, system size, and tariff.
...
- [Plug-in Solar Payback Period: Real Numbers for UK Homes](/blog/plug-in-solar-payback-period)
