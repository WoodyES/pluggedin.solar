...
**850 kWh per year in London (South-East England)**
**750 kWh per year in Manchester (North-West England)**
**680 kWh per year in Edinburgh (Scotland)**
...
See [South-Facing vs East/West](/blog/south-facing-vs-east-west-solar-uk) for deeper analysis.
...
See [Balcony Solar Output](/blog/balcony-solar-output-calculator-uk) for details.
...
A single tree casting morning shade: -5–10% output.
A building to the west casting afternoon shade: -10–15% output.
A heavy neighbouring building shadowing half the day: -40–50% output.

Use the [Solar Report](/report) to assess shading on your property.

See [Is My House Suitable for Solar?](/blog/is-my-house-suitable-for-solar-uk) for shade assessment checklist.
...
Summer (Jun–Aug) = 335 kWh (39% of annual).
Winter (Dec–Feb) = 140 kWh (16% of annual).
Seasonal ratio: 3.3:1 peak-to-trough.

See [Solar Panel Output Winter vs Summer](/blog/solar-panel-output-winter-vs-summer-uk) for seasonal deep dive.
...
See [Does Plug-in Solar Affect Energy Bill Immediately?](/blog/does-plug-in-solar-affect-energy-bill-immediately-uk) for self-consumption analysis.
...
See [How Much Does Plug-in Solar Save?](/blog/how-much-does-plug-in-solar-save-uk) for size comparison.
...
2. **Assess your aspect and shading** – run [Solar Report](/report) to grade sun exposure
3. **Calculate your real output** – [run the calculator](/calculator) with your postcode for exact figures
