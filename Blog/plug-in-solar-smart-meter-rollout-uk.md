...
2. **Accurate billing**: Your import meter reading should not be inflated by power you've generated yourself. Export measurement prevents you overpaying.

3. **Grid data**: DNOs (Distribution Network Operators) and suppliers increasingly need granular data on where power is being generated and consumed. This helps them balance supply.

4. **Future policy**: The UK government is watching how Germany's 1M+ Balkonkraftwerk installations are performing. Export measurement is part of that picture.
...
Many plug-in solar panels come with monitoring devices or smartphone apps. The [Emporia Vue 3](https://amzn.to/4bUCQ9E) is a popular choice (around £90)—it measures your whole-home energy in real time and can track solar export separately from your meter.
...
For more on plug-in solar safety and regulation, read our guide to [BS 7671 Amendment 4](/blog/bs-7671-amendment-4-plain-english-guide).
