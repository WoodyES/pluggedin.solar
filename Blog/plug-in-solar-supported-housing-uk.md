---
title: "Plug-In Solar in Supported and Sheltered Housing: UK Guide"
slug: plug-in-solar-supported-housing-uk
excerpt: "Supported and sheltered housing residents can benefit from plug-in solar. Here's how the £25m pilot may help."
date: 2026-08-14
...
Supported and sheltered housing residents — often [pensioners](/blog/plug-in-solar-pensioners-uk), people with disabilities, or those receiving care — are among those most affected by high energy costs. Plug-in solar can help, and the [£25m government pilot](/blog/25m-government-pilot-plug-in-solar-uk) specifically targets this group.

## Why It's a Good Fit

- **High daytime presence**: Residents are typically home during peak solar hours, maximising [self-consumption](/blog/plug-in-solar-self-consumption-tips-uk)
...
### Monitoring
Simple monitoring is important. The [EcoFlow app](/blog/ecoflow-stream-app-setup-monitoring-uk) shows savings in plain language, or a housing officer can check periodically.

### Maintenance
[Maintenance is minimal](/blog/how-to-maintain-plug-in-solar-panels-uk) — annual cleaning and visual inspection. The housing provider's maintenance team can handle this alongside regular property checks.

## The £25m Pilot

The [government pilot programme](/blog/25m-government-pilot-plug-in-solar-uk) is expected to prioritise:
...
The current [one-per-household rule](/blog/interim-product-specification-v2-plug-in-solar-uk) applies per dwelling, but communal solar for shared facilities may be possible under different regulations.
