...
Once your wiring checks out and your solar is connected, a [multimeter like the Fluke 117](https://amzn.to/4bSN4aq) lets you verify the system is working correctly. Check the voltage at the socket while generating — it should be between 230V and 253V. If it's higher, the backfeed may be raising voltage above safe limits, which can indicate a wiring issue.

A [smart plug like the TP-Link Tapo P110](https://amzn.to/4m9Yh9U) between the inverter and wall socket gives you continuous monitoring of power output, so you can spot any anomalies early.
