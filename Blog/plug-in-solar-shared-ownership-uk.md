---
slug: "plug-in-solar-shared-ownership-uk"
title: "Plug-in Solar for Shared Ownership Homes"
excerpt: "Can you install plug-in solar on a shared ownership property? Permission process, housing association rules, and what to expect."
date: "2026-07-03"
...
The [Renters' Rights Act 2025](/blog/renters-rights-act-solar-uk) strengthened tenants' rights regarding energy efficiency improvements. While the Act primarily targets private rentals, its principles apply to the rental component of shared ownership arrangements. Specifically:
...
- [Flat roof ballast mounts](/blog/flat-roof-plug-in-solar-uk) on extensions (weight assessment may be required)
...
If your HA refuses your application, see our guide on [what to do when permission is refused](/blog/plug-in-solar-landlord-refused-what-next-uk). The options include formal complaint, ombudsman referral, and — as a last resort — legal challenge on the grounds of unreasonable refusal.
...
1. Notify the HA in writing that you're installing solar panels (this should happen as part of the permission process anyway)
2. Ask the HA to confirm whether their building insurance covers the panels, or whether you need to insure them separately
3. Add the panels to your contents insurance — most insurers treat them as garden equipment and charge no additional premium for systems under £1,000

For a detailed breakdown, see our [solar and home insurance guide](/blog/plug-in-solar-home-insurance-uk).
...
If your shared ownership home is managed by a local council rather than an HA, the process is similar but sometimes slower. See our guide on [plug-in solar for council housing](/blog/plug-in-solar-council-housing-uk).

## Practical Recommendations

For shared ownership properties, the path of least resistance is:

1. **Choose a fully reversible installation method** — freestanding garden mount or balcony clamps. This simplifies the permission process and avoids insurance complications
2. **Apply for HA consent in writing** before buying any equipment. Include as much detail as possible upfront to avoid back-and-forth
3. **Reference the Renters' Rights Act 2025** and the UK government's approval of plug-in solar (March 2026). This frames your request in the context of national policy, not personal preference
4. **Keep all correspondence** — if the HA refuses unreasonably, you have a paper trail for escalation
5. **Notify your contents insurer** once the system is installed
